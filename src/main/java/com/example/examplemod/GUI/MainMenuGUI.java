...
public class MainMenuGUI extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.addButton(new Button(10, this.height / 2 - 10, 150, 20, new StringTextComponent("im lonely"), (button) -> {
            Minecraft.getInstance().displayGuiScreen(new net.minecraft.client.gui.screen.WorldSelectionScreen(this));
        }));

        this.addButton(new Button(this.width - 160, this.height / 2 - 10, 150, 20, new StringTextComponent("i have friends"), (button) -> {
            Minecraft.getInstance().displayGuiScreen(new net.minecraft.client.gui.screen.MultiplayerScreen(this));
        }));

        this.addButton(new Button(this.width - 160, this.height - 30, 150, 20, new StringTextComponent("shid pant"), (button) -> {
